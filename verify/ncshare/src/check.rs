//! Slow exit checkers. File layout is documented on the public crate docs.

use std::path::Path;

use serde_json::Value;

use crate::{kvm_available, parse_busbw_gbps, Error, Result, Stage};
...
pub(crate) fn check_exit(stage: Stage, output_dir: &Path) -> Result<()> {
