...
def test_all_checkers_have_positive():
    goods = {
        ...
        1: {**H200, "logit_max_abs_err": 1e-6, "grad_check": True, "overfit_one_batch": True},
        2: {**H200, "relative_loss_err": 1e-8, "routing_identical": True},
        3: {**H200, "fp8_vs_bf16_rel": 0.001, "nvfp4_numerics_ok": True},
        4: {
            **H200,
        ...
        7: {**H200, "reward_rose": True, "drift_halted": True, "planted_write_flagged": True},
        8: {**H200, "logprob_max_abs_err": 1e-5, "tiered_restore_match": True},
        9: {**H200, "planted_positive_replicated": True, "planted_negative_recorded": True},
        10: {
            **H200,
            "lost_tasks": 0,
            "duplicated_outputs": 0,
